                    ...
                    <div className="card__interior">
                        ...
                        <div className="content">
                            <div className={`section ${activeSection === 'Datos Personales' ? 'active' : ''}`}>
                                ...
                                <p className='datosPersonales_datos'>Nombre: <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <p className='datosPersonales_datos'>Apellido: <svg xmlns="http://www.w3.org/2000/svg"
                                                                                    class="icon icon-tabler icon-tabler-pencil"
                                                                                    width="28" height="28"
                                                                                    viewBox="0 0 24 24"
                                                                                    stroke-width="1.5" stroke="#ff2825"
                                ...
                                <p className='datosPersonales_datos'>Fecha de Nacimiento: <svg
                                ...
                                <p className='datosPersonales_datos'>País: <svg xmlns="http://www.w3.org/2000/svg"
                                                                                class="icon icon-tabler icon-tabler-pencil"
                                                                                width="28" height="28"
                                                                                viewBox="0 0 24 24" stroke-width="1.5"
                                                                                stroke="#ff2825" fill="none"
